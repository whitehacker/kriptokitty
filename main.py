...
# Hosting on local Postgres database, please change the username, password, and database name accordingly 
engine = engine = create_engine('postgresql://username:password@host/database_name')
